...
abstract final class CloudOSPreviewData {
  static const snapshot = CloudSystemSnapshot(
  ...
  static const files = <String, List<CloudFileItem>>{
    'home': <CloudFileItem>[
      CloudFileItem(
        name: 'Documentos',
