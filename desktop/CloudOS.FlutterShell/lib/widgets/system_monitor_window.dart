            ...
            children: <Widget>[
              ...
              Expanded(
                child: _buildMetricCard(
                  ...
                  sub: _metrics.totalDiskGb > 0
                      ? '${_metrics.usedDiskGb} / ${_metrics.totalDiskGb} GB'
                      : 'Lendo...',
              ...
              Expanded(
                child: _buildMetricCard(
                  ...
                  sub: _metrics.isLive ? 'Tempo de Atividade' : 'Aguardando sensor...',
                  icon: Icons.timer_outlined,
                  color: CloudOSColors.neonAmber,
                  progress: _metrics.isLive ? 1.0 : 0.0,
                ),
              ),
            ],
          ),
                ...
                Expanded(
                  child: _metrics.activeProcesses.isEmpty
                      ? Center(
                          child: Text(
                            _metrics.isLive
                                ? 'Nenhum processo foi retornado pelo sensor.'
                                : 'Lendo processos do sistema...',
                            style: const TextStyle(
                      ...
                      : ListView.separated(
                          ...
                          itemBuilder: (context, index) {
                            final process = _metrics.activeProcesses[index];
                            final isCloudOS = process.name
                                .toLowerCase()
                                .contains('cloudos');
                            return Container(
                              padding: const EdgeInsets.symmetric(
                              ...
                              decoration: BoxDecoration(
                                color: isCloudOS
                                    ? CloudOSColors.accent.withValues(alpha: 0.08)
                                    : Colors.transparent,
                              ...
                              child: Row(
                                children: <Widget>[
                                  ...
                                  Expanded(
                                    flex: 2,
                                    child: Text(
                                      '${process.cpuTimeSeconds.toStringAsFixed(1)} s',
                                      style: const TextStyle(
                                        fontSize: 11.5,
                                        color: CloudOSColors.neonAmber,
                                        fontFamily: 'Consolas',
