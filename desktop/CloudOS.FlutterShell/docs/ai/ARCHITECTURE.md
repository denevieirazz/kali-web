...
main.dart
  -> app/cloudos_app.dart
      -> shell/cloudos_shell.dart
          ...
          |-> features/files/*
          |-> features/start/*
          |-> taskbar / quick settings / notifications
...
Durante a modularização, imports antigos de `lib/widgets/files_window.dart` e `lib/widgets/start_panel.dart` foram preservados como exports pequenos. Isso reduz churn e permite migração gradual sem manter duas implementações.
