...
public sealed class BrowserPermissionController
{
    ...
    public static bool RequiresUserPrompt(CoreWebView2PermissionKind kind) => kind is
    ...
    internal static Task<bool> ShowTimedPromptAsync(Window owner, string title, string message, string allowText, string denyText, TimeSpan timeout)
    {
        ...
        var text = new TextBlock { Text = message, TextWrapping = TextWrapping.Wrap, FontSize = 15, Foreground = System.Windows.Media.Brushes.Black };
