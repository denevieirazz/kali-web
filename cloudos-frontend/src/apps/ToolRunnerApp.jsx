...
// ESTILOS
const styles = {
  container: { display: 'flex', flexDirection: 'column', height: '100%', background: '#0d1117', color: '#c9d1d9', fontFamily: 'Inter, sans-serif' },
  ...
  cmdBox: { flex: 1, background: '#010409', border: '1px solid #30363d', borderRadius: '6px', padding: '8px 12px', display: 'flex', alignItems: 'center', gap: '8px', fontFamily: 'JetBrains Mono, monospace', fontSize: '13px', overflowX: 'auto', whiteSpace: 'nowrap' },
  ...
  configPanel: { width: '320px', borderRight: '1px solid #30363d', display: 'flex', flexDirection: 'column', background: '#0d1117', flexShrink: 0 },
  ...
  outputPanel: { flex: 1, display: 'flex', flexDirection: 'column', background: '#010409', minWidth: 0 },
