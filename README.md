...
### Pipeline Unificado de Release (RC1.3)
...
O instalador oficial será gerado em `dist\releases\21.0.0-rc.1.3\CloudOS-Setup-21.0.0-rc.1.3-x64.exe` com seu respectivo `SHA256SUMS.txt`.
