...
test('password accepts eight characters, spaces, Unicode and passphrases without arbitrary composition rules', () => {
  ...
  assert.match(validatePassword('1234567', '1234567').error, /8 e 128/);
  assert.match(validatePassword('123', '123').error, /8 e 128/);
