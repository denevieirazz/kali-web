...
export const KALI_TOOL_MANIFEST = Object.freeze([
  ...
  { id: 'arp-scan', command: 'arp-scan', name: 'arp-scan', category: 'network', description: 'Inventário ARP de redes locais.', guiAliases: [] },
  { id: 'traceroute', command: 'traceroute', name: 'Traceroute', category: 'network', description: 'Diagnóstico de caminho de rede.', guiAliases: [] },
  { id: 'mtr', command: 'mtr', name: 'MTR', category: 'network', description: 'Diagnóstico contínuo de rota e perda.', guiAliases: [] },
  { id: 'iperf3', command: 'iperf3', name: 'iPerf3', category: 'network', description: 'Medição de desempenho entre endpoints autorizados.', guiAliases: [] },
  { id: 'ethtool', command: 'ethtool', name: 'ethtool', category: 'network', description: 'Diagnóstico de interfaces Ethernet.', guiAliases: [] },
  { id: 'iw', command: 'iw', name: 'iw', category: 'wireless', description: 'Inspeção e configuração de interfaces wireless Linux.', guiAliases: [] },
  { id: 'wavemon', command: 'wavemon', name: 'Wavemon', category: 'wireless', description: 'Monitor de sinal e parâmetros Wi‑Fi.', guiAliases: ['wavemon'] },
  ...
  { id: 'aircrack-ng', command: 'aircrack-ng', name: 'Aircrack-ng', category: 'wireless', description: 'Suite de auditoria de redes sem fio; ações ativas permanecem manuais/laboratório.', guiAliases: ['aircrack-ng'] },
  { id: 'wifite', command: 'wifite', name: 'Wifite', category: 'wireless', description: 'Orquestrador de auditoria wireless; ações ativas permanecem manuais/laboratório.', guiAliases: ['wifite'] },
  { id: 'reaver', command: 'reaver', name: 'Reaver', category: 'wireless', description: 'Ferramenta de avaliação WPS; uso ativo permanece manual/laboratório.', guiAliases: [] },
