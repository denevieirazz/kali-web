...
| Desktop | `native_desktop_window_v2.*`, `native_desktop_surface.*` |
...
Depois rode/observe o Full-System CI. Mudanças em estabilidade, lifecycle, supervisor, performance, deploy ou ativação devem manter os smokes V9–V14 verdes.

Não declare teste físico que não ocorreu. Hosted CI não prova suspend físico, transporte RDP, hotplug real, logoff/login real, reboot ou boot recovery.
