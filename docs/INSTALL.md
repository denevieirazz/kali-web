...
1. Baixe o pacote oficial: `CloudOS-Setup-21.0.0-rc.1.1-x64.exe`.
...
```cmd
CloudOS-Setup-21.0.0-rc.1.1-x64.exe /VERYSILENT /SUPPRESSMSGBOXES /NORESTART
```
...
1. Execute o script de manutenção fornecido no diretório do produto:
   ...
   ```
2. Ou execute novamente o instalador `CloudOS-Setup-21.0.0-rc.1.1-x64.exe`, que substituirá os arquivos defeituosos preservando as preferências e dados do usuário.
